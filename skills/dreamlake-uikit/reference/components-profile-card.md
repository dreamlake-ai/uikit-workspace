...
| `tags` | `ReactNode` | Final row inside the card body — a horizontal, wrapping row of `<Tag>` chips (the "Pipelines tab" pattern). Pass an array of nodes or any flex-wrap-friendly subtree. |
