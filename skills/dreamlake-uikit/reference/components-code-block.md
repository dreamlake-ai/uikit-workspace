...
`header={false}` drops the chrome entirely. `maxHeight` caps the block and
scrolls inside it; `wrap` soft-wraps instead of scrolling sideways.
...
| `lineNumbers` | `boolean` | — | Controlled line-number gutter. |
