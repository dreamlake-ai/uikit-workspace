...
A boxed chip on the 6px badge radius with a hairline border. This is what the
app reaches for when a value needs to read as a **labelled object** rather than
