...
const searchCx =
  'col-start-2 row-start-1 self-center justify-self-end mr-[56px] flex items-center gap-2 w-80 max-w-full pl-2.5 pr-1 py-1.5 bg-search rounded-[12px] border border-transparent transition-[border-color,background-color,width,box-shadow] duration-[180ms] focus-within:border-[color-mix(in_srgb,var(--color-accent)_50%,transparent)] h-7 ' +
