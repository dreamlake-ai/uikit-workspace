...
function CollapseToggle({ collapsed, onClick }: { collapsed: boolean; onClick: () => void }) {
  return (
    <button
      ...
      className="inline-flex items-center justify-center size-6 rounded-md text-uikit-muted hover:bg-uikit-ink-5 hover:text-uikit-ink transition-colors cursor-pointer"
    >
...
export function Card({
  ...
  if (collapsible && collapsed) {
    return (
      <div data-slot="card" className={cn(BASE, PADDING[size], 'flex-row items-center justify-between', className)} {...props}>
        {collapsedContent}
  ...
  return (
    <div data-slot="card" className={cn(BASE, PADDING[size], className)} {...props}>
      {collapsible && (
...
export function CardHeader({ className, size = 'lg', ...props }: CardHeaderProps) {
  return (
    <div
      data-slot="card-header"
      className={cn('flex flex-row items-center justify-between', HEADER_GAP[size], className)}
      {...props}
    />
  )
}
...
export function CardTitle({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-uikit-ink text-uikit-13 leading-uikit-snug font-medium', className)}
      {...props}
    />
  )
}
...
export function CardDescription({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-uikit-muted text-uikit-12 leading-uikit-snug', className)}
      {...props}
    />
  )
}
...
export function CardAction({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('text-uikit-muted text-uikit-12 leading-uikit-snug font-medium', className)}
      {...props}
    />
  )
}
