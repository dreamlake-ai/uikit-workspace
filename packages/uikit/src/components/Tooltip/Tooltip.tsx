...
export function Tooltip({
  ...
  const { refs, floatingStyles, context } = useFloating({
    ...
    middleware: [offset(sideOffset), flip({ fallbackAxisSideDirection: 'start' }), shift({ padding: 6 })],
  })
...
export function TooltipContent({ className, children, style, ...props }: TooltipContentProps) {
