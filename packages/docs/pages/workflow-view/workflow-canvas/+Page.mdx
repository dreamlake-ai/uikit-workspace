...
section: Workflow
order: 260
description: The presentational component that renders a typed Workflow v2 spec — stages as hubs, four node families, a live run overlay with fanned-out agents, and two orientations, in PipelineGraph's visual language.
---

import { HeroCanvasSpec } from '../../../components/specimens/workflow-view/HeroCanvasSpec'
import { MiniCanvasSpec } from '../../../components/specimens/workflow-view/MiniCanvasSpec'
import { GallerySpec } from '../../../components/specimens/workflow-view/GallerySpec'
import heroSrc from '../../../components/specimens/workflow-view/HeroCanvasSpec.tsx?raw'
import miniSrc from '../../../components/specimens/workflow-view/MiniCanvasSpec.tsx?raw'
import gallerySrc from '../../../components/specimens/workflow-view/GallerySpec.tsx?raw'

# Workflow Canvas

`WorkflowCanvas` draws a **Workflow v2 spec** as an interactive flow-chart. Like
[`PipelineGraph`](/pipeline-view/pipeline-graph) it is purely presentational —
...
run states — see [Node Types](/workflow-view/node-types).
...
<Preview source={heroSrc} filename="HeroCanvasSpec.tsx">
  <HeroCanvasSpec />
</Preview>
...
<Preview source={gallerySrc} filename="GallerySpec.tsx">
  <GallerySpec />
</Preview>
...
**Next:** [Node Types](/workflow-view/node-types) is the field-by-field
vocabulary — stage, compute, uda, sampler, control, the artifact type lattice,
and the run states · [Pipeline Graph](/pipeline-view/pipeline-graph) is the
