...
section: Get started
order: 0
description: 'Surfaces, ink, color, type, geometry, and the zebra-list patterns shared by every DreamLake page.'
---
...
The complete contract on one page: [Style guide](/style-guide). Eight sections —
...
- [Button](/components/button) — primary + ghost variants, four states.
...
<Callout variant="info" title="Reading the source">
  Every section in the style guide cites its design-guide reference
