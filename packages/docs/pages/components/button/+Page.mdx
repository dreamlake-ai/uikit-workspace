...
import { ActionSpec } from '../../../components/specimens/components/button/ActionSpec'
...
import actionSrc from '../../../components/specimens/components/button/ActionSpec.tsx?raw'
...
<Preview source={actionSrc} filename="ActionSpec.tsx">
  <ActionSpec />
</Preview>
