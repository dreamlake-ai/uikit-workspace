...
section: Components
order: 265
description: Outlined pills for picking one option (PillRadio) or several (ChipMulti).
---

import { PillSelectSpec } from '../../../components/specimens/components/pill-select/PillSelectSpec'
import pillSelectSrc from '../../../components/specimens/components/pill-select/PillSelectSpec.tsx?raw'
