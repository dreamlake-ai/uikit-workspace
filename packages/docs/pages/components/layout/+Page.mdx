...
import { SwitchSpec } from "../../../components/specimens/components/layout/SwitchSpec";
...
import switchSrc from "../../../components/specimens/components/layout/SwitchSpec.tsx?raw";
...
<Preview source={switchSrc} filename="SwitchSpec.tsx">
  <SwitchSpec />
</Preview>
