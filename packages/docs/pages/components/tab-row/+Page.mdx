...
section: Components
order: 111
description: Closable document tabs that compress to a configurable minimum width before scrolling horizontally.
---

import { TabRowSpec } from '../../../components/specimens/components/tab-row/TabRowSpec'
import tabRowSrc from '../../../components/specimens/components/tab-row/TabRowSpec.tsx?raw'
...
<Preview source={tabRowSrc} filename="TabRowSpec.tsx">
  <TabRowSpec />
</Preview>
...
Use [Tabs](/components/tabs) for underline and segmented switches. Use Tab Row for open documents or pages that need close controls and width compression.
