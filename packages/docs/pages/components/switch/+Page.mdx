...
import { SlideToggleSpec } from '../../../components/specimens/components/switch/SlideToggleSpec'
import slideToggleSrc from '../../../components/specimens/components/switch/SlideToggleSpec.tsx?raw'
...
<Preview source={slideToggleSrc} filename="SlideToggleSpec.tsx">
  <SlideToggleSpec />
</Preview>
