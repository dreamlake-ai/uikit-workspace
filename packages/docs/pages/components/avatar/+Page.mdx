...
import { HeroSpec } from '../../../components/specimens/components/avatar/HeroSpec'
import heroSrc from '../../../components/specimens/components/avatar/HeroSpec.tsx?raw'
...
<Preview source={heroSrc} filename="HeroSpec.tsx">
  <HeroSpec />
</Preview>
