...
section: Components
order: 86.5
description: A neutral framed tabbed surface for examples, scenarios and arbitrary content, based on CodeTabs.
---

import { TabbedContainer } from '@dreamlake/uikit'
...
<TabbedContainer aria-label="Container example" items={[
  {value:'starting',label:'Starting layout',children:<p>One shared starting point.</p>},
...
The [layout controller examples](/components/layout-controller) use this container
