...
section: Components
order: 50
description: Trigger-anchored dropdown menu with sections, items, dividers, and a destructive variant.
---

import { Preview } from '../../../components/Preview'
import { MinimalSpec } from '../../../components/specimens/components/menu/MinimalSpec'
import { WorkspaceSwitcherSpec } from '../../../components/specimens/components/menu/WorkspaceSwitcherSpec'
import minimalSrc from '../../../components/specimens/components/menu/MinimalSpec.tsx?raw'
import wsSrc from '../../../components/specimens/components/menu/WorkspaceSwitcherSpec.tsx?raw'
...
<Preview source={minimalSrc} filename="MinimalSpec.tsx">
  <MinimalSpec />
</Preview>
...
<Preview source={wsSrc} filename="WorkspaceSwitcherSpec.tsx">
  <WorkspaceSwitcherSpec />
</Preview>
