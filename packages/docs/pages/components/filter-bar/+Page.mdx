...
section: Components
order: 40
description: Filter chips + search input + sort dropdown, and marking the match in the results.
---
...
import { HighlightedTextSpec } from '../../../components/specimens/components/filter-bar/HighlightedTextSpec'
import highlightedTextSrc from '../../../components/specimens/components/filter-bar/HighlightedTextSpec.tsx?raw'
