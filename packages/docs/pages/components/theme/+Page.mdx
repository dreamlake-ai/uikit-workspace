...
import { ModeToggleSpec } from '../../../components/specimens/components/theme/ModeToggleSpec'
import modeToggleSrc from '../../../components/specimens/components/theme/ModeToggleSpec.tsx?raw'
...
<Preview source={modeToggleSrc} filename="ModeToggleSpec.tsx">
  <ModeToggleSpec />
</Preview>
