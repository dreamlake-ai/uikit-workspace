...
section: Components
order: 86
description: Declarative panel destinations, spawn policies and agent control, with forkable executable examples.
---

import { LayoutRequestsSpec } from "../../../components/specimens/components/panel-layout/LayoutRequestsSpec";
