...
section: Components
order: 131
description: Flow-layout virtual list — items in CSS normal flow, so sticky / gap / scroll-anchor work like a non-virtual list.
---
...
<div overflow-auto height>                 ← scroll container
  ...
  <div padding-top padding-bottom>          ← flow shell
    <Item /> <Item /> …                     ← visible items, in normal flow
  </div>
</div>
```
