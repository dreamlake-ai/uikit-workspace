...
import { SelectionRunSpec } from '../../../components/specimens/components/tree-view/SelectionRunSpec'
import selectionRunSrc from '../../../components/specimens/components/tree-view/SelectionRunSpec.tsx?raw'
...
import { QuietSpec } from "../../../components/specimens/components/tree-view/QuietSpec";
...
import quietSrc from "../../../components/specimens/components/tree-view/QuietSpec.tsx?raw";
...
crosses. See [Color → Lines that cross rows](/style-guide#lines-that-cross-rows).
...
<Preview source={quietSrc} filename="QuietSpec.tsx">
  <QuietSpec />
</Preview>
...
<Preview source={selectionRunSrc} filename="SelectionRunSpec.tsx">
  <SelectionRunSpec />
</Preview>
