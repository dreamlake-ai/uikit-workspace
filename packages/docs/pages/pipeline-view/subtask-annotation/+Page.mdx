...
section: Pipeline
order: 250
description: A worked example — the Macrodata Labs robot-video subtask annotation pipeline (contact-sheet segmentation → windowed labeling with Gemini) rendered as a PipelineGraph.
fullscreen: true
---

import { SubtaskGraphSpec } from '../../../components/specimens/pipeline-view/subtask-annotation/SubtaskGraphSpec'
import { SubtaskLinkedSpec } from '../../../components/specimens/pipeline-view/subtask-annotation/SubtaskLinkedSpec'
import subtaskGraphSrc from '../../../components/specimens/pipeline-view/subtask-annotation/SubtaskGraphSpec.tsx?raw'
import subtaskLinkedSrc from '../../../components/specimens/pipeline-view/subtask-annotation/SubtaskLinkedSpec.tsx?raw'
...
**AI auto-label → review → sink** loop the [Pipeline Graph](/pipeline-view/pipeline-graph)
...
<Preview source={subtaskGraphSrc} filename="SubtaskGraphSpec.tsx">
  <SubtaskGraphSpec />
</Preview>

<Callout variant="info" title="This graph is a hand-authored trace">
The reference pipeline ships in Macrodata's <code>Refiner</code> framework. The
...
<Preview source={subtaskLinkedSrc} filename="SubtaskLinkedSpec.tsx">
  <SubtaskLinkedSpec />
</Preview>
...
Macrodata Labs · **See also:** [Pipeline Graph](/pipeline-view/pipeline-graph)
(the component) · [Anatomy](/pipeline-view/anatomy) (field-to-pixel map) ·
[Pipeline Graph JSON](/pipeline-view/pipeline-graph-json) (the data model).
