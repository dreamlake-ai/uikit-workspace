...
const SAMPLES = {
  "image_object_annotation": {
    ...
    "subtitle": "我想标注这个图像中的物体 — annotate the objects in this image.",
    "nodes": {
      "source": {
        "id": "source",
        "title": "source",
